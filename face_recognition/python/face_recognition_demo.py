...
def build_argparser():
    ...
    gallery.add_argument('-fg', default='./datasets/hoanghaiduong', help='Optional. Path to the face images directory.')
    ...
    models.add_argument('-m_fd', type=Path, required=False,
                        default="./models/face-detection-retail-0005.xml",
...
def draw_detections(frame, frame_processor, detections, output_transform):
    ...
    for roi, landmarks, identity in zip(*detections):
        ...
        if identity.id != FaceIdentifier.UNKNOWN_ID and confidence>83.0 :
            text += ' %.2f%%' % confidence
        else:
            text = 'Unknown %.2f%%'
